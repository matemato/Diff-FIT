...
from face_parsing.segmentation_models.resnet import resnet18, resnet34
...
class BiSeNet(nn.Module):
    def __init__(self, num_classes, backbone_name="resnet18"):
        ...
        self.conv_out = BiSeNetOutput(
            in_channels=256, mid_channels=256, num_classes=num_classes
        )
        self.conv_out16 = BiSeNetOutput(
            in_channels=128, mid_channels=64, num_classes=num_classes
        )
