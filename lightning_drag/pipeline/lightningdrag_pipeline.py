...
from diffusers.pipelines.stable_diffusion import (
    StableDiffusionPipelineOutput as OriginalOutput,
)
...
from lightning_drag.drag_utils.utils import torch_dfs
from lightning_drag.models.appearance_encoder import AppearanceEncoderModel
from lightning_drag.models.attention_processor import (
    IPAttnProcessor,
    PointEmbeddingAttnProcessor,
)
from lightning_drag.models.mutual_self_attention import ReferenceAttentionControl


@dataclass
class StableDiffusionPipelineOutputWithLatents(OriginalOutput):
...
class LightningDragPipeline(StableDiffusionPipeline):
    ...
    def __call__(
        ...
        return StableDiffusionPipelineOutputWithLatents(
